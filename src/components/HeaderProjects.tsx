...
const HeaderProjects = ({ lang, language }) => {
  ...
  const navItems = [
    { href: `/portfolio/#/${language}/#home`, label: lang("HEADER_icon_home"), icon: Home },
    { href: language == "fr" ? "/portfolio/#/en/projects" : "/portfolio/#/fr", icon: language == "fr" ? us : fr },
  ];
