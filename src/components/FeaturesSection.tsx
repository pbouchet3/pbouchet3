  ...
  const features = [
    {
      ...
      description: "Front-End modèrne et fonctionnel avec React, TypeScript et Tailwind CSS. Concéption responsive et accéssible.",
    ...
    },
    {
      ...
      description: "Back-End robuste type API RESTful. Securisé par Bearer Token, JWT et OAuth2.0. Gestion de données utilisateurs...",
    ...
    },
    {
      ...
      description: "Création d'infrastructures de bases de données relationnelles et non relationnelles. Optimisation des requetes SQL.",
    ...
    },
    {
      ...
      subtitle: "C/C++",
      description: "Création de logiciels de production robuste, et performant. Déstinés a une chaine de production d'usine",
...

    {
      ...
      description: "Déploiement avec Docker et Docker Compose, déploiement de serveurs en parallel via Ansible, et géstion de version avec Git.",
    ...
    },
    {
      ...
      description: "Scripting d'automatisations pour des tâches répetitives, et déploiement de scripts sur des serveurs distants.",
